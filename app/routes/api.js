...
//var UserCtr = require('.../controllers/userCtrl'); // Import User Model
...
module.exports = function(router) {
    ...
    var client = nodemailer.createTransport({
        service: 'Zoho',
        auth: {
            user: 'tunehunt@zoho.com', // Your email address
            pass: 'Password@123' // Your password
        },
    });
    ...
    router.post('/users', function(req, res) {
     ...
     //   var getLong = sessionStorage.getItem("long");
     //   console.log(getLat, getLong);
       ...
       console.log(req.body.location);
        ...
        user.location = req.body.location;// [-98.35,39.50];//[userCtrl.long,userCtrl.lat];//[-98.35,39.50];//[long, lat];
        ...
        if (req.body.username === null || req.body.username === '' || req.body.password === null || req.body.password === '' || req.body.email === null || req.body.email === '' || req.body.name === null || req.body.name === '') {
            ...
            user.save(function(err) {
                if (err) {
                    ...
                    var email = {
                        from: 'Tune Hunt Staff, tunehunt@zoho.com',
                        to: [user.email],//, 'jeevithagudivada@gmail.com'
                        subject: 'Your TuneHunt Activation Link',
                        text: 'Hello ' + user.name + ', thank you for registering at localhost.com. Please click on the following link to complete Your TuneHunt Activation: /activate/' + user.temporarytoken,
                        html: 'Hello<strong> ' + user.name + '</strong>,<br><br>Thank you for registering at localhost.com. Please click on the link below to complete Your TuneHunt Activation:<br><br><a href="http://localhost:3000/activate/' + user.temporarytoken + '">http://localhost:3000/activate/</a>'
                    };
                ...
                user.save(function(err) {
                    if (err) {
                        ...
                        var email = {
                            ...
                            text: 'Hello ' + user.name + ', You recently requested a new account activation link. Please click on the following link to complete Your TuneHunt Activation: https://immense-dusk-71112.herokuapp.com/activate/' + user.temporarytoken,
                            html: 'Hello<strong> ' + user.name + '</strong>,<br><br>You recently requested a new account activation link. Please click on the link below to complete Your TuneHunt Activation:<br><br><a href="http://localhost:3000/activate/' + user.temporarytoken + '">http://localhost:3000/activate/</a>'
                        };
        ...
        User.findOne({ email: req.params.email }).select('email name username').exec(function(err, user) {
            if (err) {
                ...
                if (!user) {
                    ...
                    var email = {
                        from: 'Localhost Staff, tunehunt@zoho.com',
                        to: user.email,
